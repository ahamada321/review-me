...
@Component({
  selector: "app-users-revenues",
  templateUrl: "./users-revenues.component.html",
  styleUrls: ["./users-revenues.component.scss"],
})
export class UsersRevenuesComponent implements OnInit {
