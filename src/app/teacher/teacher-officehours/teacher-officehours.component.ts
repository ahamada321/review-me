...
@Component({
  selector: 'app-teacher-officehours',
  templateUrl: './teacher-officehours.component.html',
  styleUrls: ['./teacher-officehours.component.scss'],
})
export class TeacherOfficehoursComponent implements OnInit {
